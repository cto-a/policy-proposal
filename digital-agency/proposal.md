...
## 4：データ駆動とKPI
よりよいサービスを創るためには、素早く正確な事実認識に基づくことが最も重要です。様々な行政活動のデータを蓄積分析し、数値目標を持って改善を進めていくべきです。
...
P
さまざまな政策・施策は行政サービスを通じてリアルタイムに得られた市民の動向によって
改善のための指標を掲げる。国民市民の状況をリアルタイムに可視化して、改善に良いフィードバックをもたらすこと。
データドリブン
計測
分析、インサイトの発見
KPIと目標の設定と透明化
